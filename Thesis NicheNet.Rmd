...
plots <- lapply(metrics, function(metric) {
  p <- ggplot(ligand_importances, aes(x = setting, y = .data[[metric]])) +
    geom_boxplot() +
    geom_jitter(aes(color = factor(test_ligand)), width = 0.2, alpha = 0.7) +
    labs(title = metric,
         x = " ",
         y = metric) +
...
# Display the combined plots with a single legend
combined_plots +
  theme(legend.position = "bottom",  # Place the legend at the bottom
        legend.box = "vertical",     # Arrange legend items vertically
        legend.margin = margin(t = 0, unit = "pt", b = 20, l = 0, r = 0))  # Adjust legend margin

# Save the combined plots with the overall title in the middle and a single legend
ggsave("ligand_activity_NicheNet.png", plot = combined_plots, width = 20, height = 20, dpi = 300)
...
# Save the combined plots with the overall title in the middle and a single legend
ggsave("ligand_activity_NicheNet_ATAC_24_NO_RNA.png", plot = combined_plots, width = 20, height = 20, dpi = 300)
```
...
# Save the combined plots with the overall title in the middle and a single legend
ggsave("ligand_activity_NicheNet_ATAC_24_with_RNA.png", plot = combined_plots, width = 20, height = 20, dpi = 300)
```
...
#import one ligand GRN networks (Ruth generated from https://zenodo.org/record/7418451#.ZGNiqXZBx9O (ANANSE networks))
gr_network_LINCS_OSM <- read.delim2("C:/Users/klara/MaStat/Thesis/GithubThesis/Thesis_NicheNet/Ananse_networks/GRN/LINCS_MCF10A_OSM_48_NO_RNAseq_grn.txt", header = TRUE, sep = ";")
gr_network_LINCS_HGF <- read.delim2("C:/Users/klara/MaStat/Thesis/GithubThesis/Thesis_NicheNet/Ananse_networks/GRN/LINCS_MCF10A_HGF_48_NO_RNAseq_grn.txt", header = TRUE, sep = ";")
gr_network_LINCS_EGF <- read.delim2("C:/Users/klara/MaStat/Thesis/GithubThesis/Thesis_NicheNet/Ananse_networks/GRN/LINCS_MCF10A_EGF_48_NO_RNAseq_grn.txt", header = TRUE, sep = ";")
...
# Save the combined plots with the overall title in the middle and a single legend
ggsave("ligand_activity_NicheNet_ATAC_48_no_RNA.png", plot = combined_plots, width = 20, height = 20, dpi = 300)
```
...
# Save the combined plots with the overall title in the middle and a single legend
ggsave("ligand_activity_NicheNet_ATAC_48_with_RNA.png", plot = combined_plots, width = 20, height = 20, dpi = 300)
