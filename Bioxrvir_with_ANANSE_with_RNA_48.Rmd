---
title: "with ANANSE with RNA_seq 48"
...
gr_network_LINCS_OSM <- read.delim("Ananse_networks/GRN/LINCS_MCF10A_OSM_48_grn.txt", header = TRUE, sep = ";")
gr_network_LINCS_HGF <- read.delim("Ananse_networks/GRN/LINCS_MCF10A_HGF_48_grn.txt", header = TRUE, sep = ";")
gr_network_LINCS_EGF <- read.delim("Ananse_networks/GRN/LINCS_MCF10A_EGF_48_grn.txt", header = TRUE, sep = ";")
...
if(length(expression_settings_validation_DE_one) > 0){
  ...
  writexl::write_xlsx(performances_one, path = "NicheNet_output/performances_one_ANANSE_with_RNA_48.xlsx")
  ...
  print(performances_one %>%
          ...
          theme_bw() +
          ggtitle("48h with ANANSE data only one ligand with RNA")
  )
}
...
if(length(settings_one) > 0){
  ...
  writexl::write_xlsx(evaluation_ligand_prediction_one, path = "NicheNet_output/ligand_one_ANANSE_with_RNA_48.xlsx")
