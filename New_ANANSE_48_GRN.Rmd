...
# Obtain the different conditions at 48h
values <- stringr::str_split(metadata$specimenName, "_") %>% 
                  do.call(rbind, .) 

# Obtain all the ids of samples at 48h
id_48 <- metadata[which(values[,2] == 48 & metadata$RNAseq_QCpass == TRUE),]$specimenID

# Subset the raw RNAseq data and metadata for 48h
...
if(length(settings_one) > 0){
  ...
  print(evaluation_ligand_prediction_NicheNet %>%
    ...
    ggtitle("NicheNet 48h")
  
  # Visualisation thesis, of the ligand importances
  ...
  ggplot(ligand_importances_one, aes(x = setting, y = .data[[metric]])) +
    ...
    theme(legend.title = element_blank(), legend.text = element_text(size = 18), axis.text.x = element_text(angle = 0, hjust = 0.5))
    })
  
  # Combine plots 
  combined_plots <- wrap_plots(plots, ncol = 2) +
  plot_annotation(title = "Ligand activity prediction evaluation 48h", theme = theme(plot.title = element_text(size = 24, hjust = 0.5))) +
  theme(legend.position = "bottom") 
  
  
  combined_plots
  ggsave("ligand_activity_NicheNet_48.png", plot = combined_plots, width = 13, height = 12, dpi = 300)
  }
...
##HGF
GRN_HGF_48_ATAC_RNA <- read.delim2("C:/Users/klara/MaStat/Thesis/GithubThesis/Thesis_NicheNet/Ananse_networks/GRN/LINCS_MCF10A_HGF_48_grn.txt", header = TRUE, sep = ";")

# adding our GRN as a new source to the optimized weights
new_gr_network <- gr_network %>% bind_rows(GRN_HGF_48_ATAC_RNA)

new_network_weights_df <- tibble(
  source = "LINCS_MCF10A_HGF_48", 
  avg_weight = 1, 
  median_weight = 1)
...
ligand_target_matrix_HGF_48_ATAC_RNA <- construct_ligand_target_matrix(
  weighted_networks = weighted_networks, 
...
ligand_target_matrix_HGF_48_ATAC_RNA <-
 subset(ligand_target_matrix_HGF_48_ATAC_RNA, rownames(ligand_target_matrix_HGF_48_ATAC_RNA) %in% rownames(ligand_target_matrix))

# Plot the differences in RP
plot(ligand_target_matrix[,"HGF"], ligand_target_matrix_HGF_48_ATAC_RNA[,"HGF"],
     xlab = "NicheNet default regulatory potentials",
     ylab = "Regulatory potentials with ATAC+RNA",
     main = "Regulatory potentials HGF 48h")

##OSM
GRN_OSM_48_ATAC_RNA <- read.delim2("C:/Users/klara/MaStat/Thesis/GithubThesis/Thesis_NicheNet/Ananse_networks/GRN/LINCS_MCF10A_OSM_48_grn.txt", header = TRUE, sep = ";")

# adding our GRN as a new source to the optimized weights
new_gr_network <- gr_network %>% bind_rows(GRN_OSM_48_ATAC_RNA)

new_network_weights_df <- tibble(
  source = "LINCS_MCF10A_OSM_48", 
  avg_weight = 1, 
  median_weight = 1)
...
ligand_target_matrix_OSM_48_ATAC_RNA <- construct_ligand_target_matrix(
  weighted_networks = weighted_networks, 
  ligands = ligands, algorithm = "PPR",
  damping_factor = hyperparameter_list %>% 
    filter(parameter == "damping_factor") %>% 
...
# there are more genes added, we should filter that since the dimensions no longer match, how can we select them in the right order without changing the format? Still need to address this.
ligand_target_matrix_OSM_48_ATAC_RNA <-
 subset(ligand_target_matrix_OSM_48_ATAC_RNA, rownames(ligand_target_matrix_OSM_48_ATAC_RNA) %in% rownames(ligand_target_matrix))

# plot the differences in RP
plot(ligand_target_matrix[,"OSM"], ligand_target_matrix_OSM_48_ATAC_RNA[,"OSM"],
     xlab = "NicheNet default regulatory potentials",
     ylab = "Regulatory potentials with ATAC+RNA",
     main = "Regulatory potentials OSM 48h")

##EGF
GRN_EGF_48_ATAC_RNA <- read.delim2("C:/Users/klara/MaStat/Thesis/GithubThesis/Thesis_NicheNet/Ananse_networks/GRN/LINCS_MCF10A_EGF_48_grn.txt", header = TRUE, sep = ";")

# adding our GRN as a new source to the optimized weights
new_gr_network <- gr_network %>% bind_rows(GRN_EGF_48_ATAC_RNA)

new_network_weights_df <- tibble(
  source = "LINCS_MCF10A_EGF_48", 
  avg_weight = 1, 
  median_weight = 1)
...
# only one row is adapted, so correct for this
ligand_target_matrix_EGF_48_ATAC_RNA <- construct_ligand_target_matrix(
  weighted_networks = weighted_networks, 
  ligands = ligands, algorithm = "PPR",
  damping_factor = hyperparameter_list %>% 
    filter(parameter == "damping_factor") %>% 
...
# there are more genes added, we should filter that since the dimensions no longer match, how can we select them in the right order without changing the format? Still need to address this.
ligand_target_matrix_EGF_48_ATAC_RNA <-
 subset(ligand_target_matrix_EGF_48_ATAC_RNA, rownames(ligand_target_matrix_EGF_48_ATAC_RNA) %in% rownames(ligand_target_matrix))

# Plot the differences in RP
plot(ligand_target_matrix[,"EGF"], ligand_target_matrix_EGF_48_ATAC_RNA[,"EGF"],
     xlab = "NicheNet default regulatory potentials",
     ylab = "Regulatory potentials with ATAC+RNA",
     main = "Regulatory potentials EGF 48h")

# Make one ligand target matrix
ligand_target_matrix_ATAC_RNA <- cbind(ligand_target_matrix_EGF_48_ATAC_RNA, ligand_target_matrix_HGF_48_ATAC_RNA, ligand_target_matrix_OSM_48_ATAC_RNA)

diff_rows_EGF_ATAC_RNA <- which(ligand_target_matrix[, "EGF"] != ligand_target_matrix_EGF_48_ATAC_RNA[, 1])
diff_rows_HGF_ATAC_RNA <- which(ligand_target_matrix[, "HGF"] != ligand_target_matrix_HGF_48_ATAC_RNA[, 1])
diff_rows_OSM_ATAC_RNA <- which(ligand_target_matrix[, "OSM"] != ligand_target_matrix_OSM_48_ATAC_RNA[, 1])
...
##HGF
GRN_HGF_48_ATAC <- read.delim2("C:/Users/klara/MaStat/Thesis/GithubThesis/Thesis_NicheNet/Ananse_networks/GRN/LINCS_MCF10A_HGF_48_NO_RNAseq_grn.txt", header = TRUE, sep = ";")

# adding our GRN as a new source to the optimized weights
new_gr_network <- gr_network %>% bind_rows(GRN_HGF_48_ATAC)

new_network_weights_df <- tibble(
  source = "LINCS_MCF10A_HGF_48_NO_RNAseq", 
  avg_weight = 1, 
  median_weight = 1)
...
# only one row is adapted, so should correct for this
ligand_target_matrix_HGF_48_ATAC <- construct_ligand_target_matrix(
  weighted_networks = weighted_networks, 
  ligands = ligands, algorithm = "PPR",
  damping_factor = hyperparameter_list %>% 
    filter(parameter == "damping_factor") %>% 
...
# there are more genes added, we should filter that since the dimensions no longer match, how can we select them in the right order without changing the format? Still need to address this.
ligand_target_matrix_HGF_48_ATAC <-
 subset(ligand_target_matrix_HGF_48_ATAC, rownames(ligand_target_matrix_HGF_48_ATAC) %in% rownames(ligand_target_matrix))

# Plot the differences in RP
plot(ligand_target_matrix[,"HGF"], ligand_target_matrix_HGF_48_ATAC[,"HGF"],
     xlab = "NicheNet default regulatory potentials",
     ylab = "Regulatory potentials with ATAC",
     main = "Regulatory potentials HGF 48h")

##OSM
GRN_OSM_48_ATAC <- read.delim2("C:/Users/klara/MaStat/Thesis/GithubThesis/Thesis_NicheNet/Ananse_networks/GRN/LINCS_MCF10A_OSM_48_NO_RNAseq_grn.txt", header = TRUE, sep = ";")

# adding our GRN as a new source to the optimized weights
new_gr_network <- gr_network %>% bind_rows(GRN_OSM_48_ATAC)

new_network_weights_df <- tibble(
  source = "LINCS_MCF10A_OSM_48_NO_RNAseq", 
  avg_weight = 1, 
  median_weight = 1)
...
# only one row is adapted, so should correct for this
ligand_target_matrix_OSM_48_ATAC <- construct_ligand_target_matrix(
  weighted_networks = weighted_networks, 
  ligands = ligands, algorithm = "PPR",
  damping_factor = hyperparameter_list %>% 
    filter(parameter == "damping_factor") %>% 
...
# there are more genes added, we should filter that since the dimensions no longer match, how can we select them in the right order without changing the format? Still need to address this.
ligand_target_matrix_OSM_48_ATAC <-
 subset(ligand_target_matrix_OSM_48_ATAC, rownames(ligand_target_matrix_OSM_48_ATAC) %in% rownames(ligand_target_matrix))

# Plot the differences in RP
plot(ligand_target_matrix[,"OSM"], ligand_target_matrix_OSM_48_ATAC[,"OSM"],
     xlab = "NicheNet default regulatory potentials",
     ylab = "Regulatory potentials with ATAC",
     main = "Regulatory potentials OSM 48h")

##EGF
GRN_EGF_48_ATAC <- read.delim2("C:/Users/klara/MaStat/Thesis/GithubThesis/Thesis_NicheNet/Ananse_networks/GRN/LINCS_MCF10A_EGF_48_NO_RNAseq_grn.txt", header = TRUE, sep = ";")

# adding our GRN as a new source to the optimized weights
new_gr_network <- gr_network %>% bind_rows(GRN_EGF_48_ATAC)

new_network_weights_df <- tibble(
  source = "LINCS_MCF10A_EGF_48_NO_RNAseq", 
  avg_weight = 1, 
  median_weight = 1)
...
# only one row is adapted, so should correct for this
ligand_target_matrix_EGF_48_ATAC <- construct_ligand_target_matrix(
  weighted_networks = weighted_networks, 
  ligands = ligands, algorithm = "PPR",
  damping_factor = hyperparameter_list %>% 
    filter(parameter == "damping_factor") %>% 
...
# there are more genes added, we should filter that since the dimensions no longer match, how can we select them in the right order without changing the format? Still need to address this.
ligand_target_matrix_EGF_48_ATAC <-
 subset(ligand_target_matrix_EGF_48_ATAC, rownames(ligand_target_matrix_EGF_48_ATAC) %in% rownames(ligand_target_matrix))

# Plot the differences in RP
plot(ligand_target_matrix[,"EGF"], ligand_target_matrix_EGF_48_ATAC[,"EGF"],
     xlab = "NicheNet default regulatory potentials",
     ylab = "Regulatory potentials with ATAC",
     main = "Regulatory potentials EGF 48h")

# Make one ligand target matrix
ligand_target_matrix_ATAC <- cbind(ligand_target_matrix_EGF_48_ATAC, ligand_target_matrix_HGF_48_ATAC, ligand_target_matrix_OSM_48_ATAC)

diff_rows_EGF_ATAC <- which(ligand_target_matrix[, "EGF"] != ligand_target_matrix_EGF_48_ATAC[, 1])
diff_rows_HGF_ATAC <- which(ligand_target_matrix[, "HGF"] != ligand_target_matrix_HGF_48_ATAC[, 1])
diff_rows_OSM_ATAC <- which(ligand_target_matrix[, "OSM"] != ligand_target_matrix_OSM_48_ATAC[, 1])
...
targets.HGF_ATAC <- unique(GRN_HGF_48_ATAC$to) 
targets.EGF_ATAC <- unique(GRN_EGF_48_ATAC$to) 
targets.OSM_ATAC <- unique(GRN_OSM_48_ATAC$to) 

# Select the targets of the ligand-target matrices of Ananse with ATAC+RNA
targets.HGF_ATAC_RNA <- unique(GRN_HGF_48_ATAC_RNA$to) 
targets.EGF_ATAC_RNA <- unique(GRN_EGF_48_ATAC_RNA$to) 
targets.OSM_ATAC_RNA <- unique(GRN_OSM_48_ATAC_RNA$to)
...
table(DE_info$OSM$external_gene_name %in% GRN_OSM_48_ATAC$to)
table(DE_info$EGF$external_gene_name %in% GRN_EGF_48_ATAC$to)
table(DE_info$HGF$external_gene_name %in% GRN_HGF_48_ATAC$to)

# Check how many differentially expressed genes are in the ANANSE GRNs (ATAC+RNA)
table(DE_info$OSM$external_gene_name %in% GRN_OSM_48_ATAC_RNA$to)
table(DE_info$EGF$external_gene_name %in% GRN_EGF_48_ATAC_RNA$to)
table(DE_info$HGF$external_gene_name %in% GRN_HGF_48_ATAC_RNA$to)


# Count occurrences of each gene name in GRN_OSM_48_ATAC_RNA$to
gene_counts_OSM_ATAC_RNA <- table(GRN_OSM_48_ATAC_RNA$to)
gene_counts_EGF_ATAC_RNA <- table(GRN_EGF_48_ATAC_RNA$to)
gene_counts_HGF_ATAC_RNA <- table(GRN_HGF_48_ATAC_RNA$to)

gene_counts_OSM_ATAC <- table(GRN_OSM_48_ATAC$to)
gene_counts_EGF_ATAC <- table(GRN_EGF_48_ATAC$to)
gene_counts_HGF_ATAC <- table(GRN_HGF_48_ATAC$to)
...
print(paste("ATAC+RNA OSM: links in GRN with DE genes:", as.character(total_matching_rows_OSM_ATAC_RNA), "links without DE genes:", as.character(length(GRN_OSM_48_ATAC_RNA$to) - total_matching_rows_OSM_ATAC_RNA), "percentage:", as.character(total_matching_rows_OSM_ATAC_RNA/length(GRN_OSM_48_ATAC_RNA$to))))

print(paste("ATAC+RNA EGF: links in GRN with DE genes:", as.character(total_matching_rows_EGF_ATAC_RNA), "links without DE genes:", as.character(length(GRN_EGF_48_ATAC_RNA$to) - total_matching_rows_EGF_ATAC_RNA), "percentage:", as.character(total_matching_rows_EGF_ATAC_RNA/length(GRN_EGF_48_ATAC_RNA$to))))

print(paste("ATAC+RNA HGF: links in GRN with DE genes:", as.character(total_matching_rows_HGF_ATAC_RNA), "links without DE genes:", as.character(length(GRN_HGF_48_ATAC_RNA$to) - total_matching_rows_HGF_ATAC_RNA), "percentage:", as.character(total_matching_rows_HGF_ATAC_RNA/length(GRN_HGF_48_ATAC_RNA$to))))

print(paste("ATAC OSM: links in GRN with DE genes:", as.character(total_matching_rows_OSM_ATAC), "links without DE genes:", as.character(length(GRN_OSM_48_ATAC$to) - total_matching_rows_OSM_ATAC), "percentage:", as.character(total_matching_rows_OSM_ATAC/length(GRN_OSM_48_ATAC$to))))

print(paste("ATAC EGF: links in GRN with DE genes:", as.character(total_matching_rows_EGF_ATAC), "links without DE genes:", as.character(length(GRN_EGF_48_ATAC$to) - total_matching_rows_EGF_ATAC), "percentage:", as.character(total_matching_rows_EGF_ATAC/length(GRN_EGF_48_ATAC$to))))

print(paste("ATAC HGF: links in GRN with DE genes:", as.character(total_matching_rows_HGF_ATAC), "links without DE genes:", as.character(length(GRN_HGF_48_ATAC$to) - total_matching_rows_HGF_ATAC), "percentage:", as.character(total_matching_rows_HGF_ATAC/length(GRN_HGF_48_ATAC$to))))

# IS THIS NEEDED?
length(unique(GRN_OSM_48_ATAC$to)) - (table(DE_info$OSM$external_gene_name %in% GRN_OSM_48_ATAC$to)["TRUE"])
length(unique(GRN_EGF_48_ATAC$to)) - (table(DE_info$EGF$external_gene_name %in% GRN_EGF_48_ATAC$to)["TRUE"])
length(unique(GRN_HGF_48_ATAC$to)) - (table(DE_info$HGF$external_gene_name %in% GRN_HGF_48_ATAC$to)["TRUE"])
```
...
length(intersect(targets.HGF_ATAC, targets.RNA)) # very high 5025
length(intersect(targets.EGF_ATAC, targets.RNA)) # very high 5034
length(intersect(targets.OSM_ATAC, targets.RNA)) # very high 4945

length(intersect(targets.HGF_ATAC_RNA, targets.RNA)) # very high 
length(intersect(targets.EGF_ATAC_RNA, targets.RNA)) # very high 
length(intersect(targets.OSM_ATAC_RNA, targets.RNA)) # very high 

length(intersect(intersect(targets.NN,targets.HGF_ATAC), targets.RNA)) # very reasonable 3348
length(intersect(intersect(targets.NN,targets.EGF_ATAC), targets.RNA)) # very reasonable 3355
length(intersect(intersect(targets.NN,targets.OSM_ATAC), targets.RNA)) # very reasonable 3317

length(intersect(intersect(targets.NN,targets.HGF_ATAC_RNA), targets.RNA)) # very reasonable 3348
length(intersect(intersect(targets.NN,targets.EGF_ATAC_RNA), targets.RNA)) # very reasonable 3355
length(intersect(intersect(targets.NN,targets.OSM_ATAC_RNA), targets.RNA)) # very reasonable 3317
```
...
if(length(expression_settings_validation_DE_one) > 0){
  ...
  print(performances_ATAC_RNA %>%
          ...
          geom_hline(aes(yintercept = scorevalue), data = scorerandom, linetype = 2, color = "red") +
          theme_bw() +
          ggtitle("48h with ANANSE data ATAC+RNA")
  )
  ...
  print(performances_ATAC %>%
          ...
          geom_hline(aes(yintercept = scorevalue), data = scorerandom, linetype = 2, color = "red") +
          theme_bw() +
          ggtitle("48h with ANANSE data ATAC")
  )
  ...
  geom_hline(aes(yintercept = scorevalue), data = scorerandom, linetype = 2, color = "red") +
  theme_bw() +
  labs(title = "Transcriptional response prediction evaluation 48h including ATAC+RNA", color = "", x = "") +  
  theme(plot.title = element_text(size = 15, hjust = 0.5, face = "bold"), strip.text = element_text(face = "bold"))
  
  #Save the plot for later use
  ggsave("p_n_48_ATAC_RNA.png", plot = p_n_ATAC_RNA)
  ...
  geom_hline(aes(yintercept = scorevalue), data = scorerandom, linetype = 2, color = "red") +
  theme_bw() +
  labs(title = "Transcriptional response prediction evaluation 48h including ATAC", color = "", x = "") +  
  theme(plot.title = element_text(size = 15, hjust = 0.5, face = "bold"), strip.text = element_text(face = "bold"))
  
  #Save the plot for later use
  ggsave("p_n_48_ATAC.png", plot = p_n_ATAC_RNA)
...
# Visualisation thesis
  ...
  # Combine plots 
  combined_plots <- wrap_plots(plots, ncol = 2) +
  plot_annotation(title = "Ligand activity prediction evaluation 48h ATAC+RNA", theme = theme(plot.title = element_text(size = 24, hjust = 0.5))) +
  theme(legend.position = "bottom") 
  
  combined_plots
  ggsave("ligand_activity_ATAC_RNA_48.png", plot = combined_plots, width = 13, height = 12, dpi = 300)
  ...
  # Combine plots 
  combined_plots <- wrap_plots(plots, ncol = 2) +
  plot_annotation(title = "Ligand activity prediction evaluation 48h ATAC", theme = theme(plot.title = element_text(size = 24, hjust = 0.5))) +
  theme(legend.position = "bottom") 
  
  combined_plots
  ggsave("ligand_activity_ATAC_48.png", plot = combined_plots, width = 13, height = 12, dpi = 300)
```
...
au_plot_ATAC_RNA <- ggwithinstats(
  ...
  ggtitle("AUROC NicheNet vs ATAC+RNA 48h") +
...
aupr_plot_ATAC_RNA <- ggwithinstats(
  ...
  ggtitle ("AUPR NicheNet vs ATAC+RNA 48h") +
  theme(plot.title = element_text(hjust = 0.5))
...
gs_plot_ATAC_RNA <- ggwithinstats(
  ...
  ggtitle ("mean rank GST log pval NicheNet vs ATAC+RNA 48h") +
  theme(plot.title = element_text(hjust = 0.5))
...
iregulon_plot_ATAC_RNA <- ggwithinstats(
  ...
  ggtitle ("AUC NicheNet vs ATAC+RNA 48h") +
  theme(plot.title = element_text(hjust = 0.5))
...
sp_plot_ATAC_RNA <- ggwithinstats(
  ...
  ggtitle ("Spearman NicheNet vs ATAC+RNA 48h") +
  theme(plot.title = element_text(hjust = 0.5))
...
pe_plot_ATAC_RNA <- ggwithinstats(
  ...
  geom_text(aes(label = perf_ATAC_RNA[which(perf_ATAC_RNA$scorename == "pearson"),]$setting), size = 3,  hjust = 2.5, size = 20, fontface = "bold") +
  ggtitle ("Pearson NicheNet vs ATAC+RNA 48h") +
  theme(plot.title = element_text(hjust = 0.5))
...
ggsave("perf_stats_ATAC_RNA_48.png", combined_plot, width = 13, height = 11)
```
...
au_plot_ATAC <- ggwithinstats(
  ...
  ggtitle("AUROC NicheNet vs ATAC 48h") +
  theme(plot.title = element_text(hjust = 0.5))
...
aupr_plot_ATAC <- ggwithinstats(
  ...
  ggtitle ("AUPR NicheNet vs ATAC 48h") +
  theme(plot.title = element_text(hjust = 0.5))
...
gs_plot_ATAC <- ggwithinstats(
  ...
  ggtitle ("mean rank GST log pval NicheNet vs ATAC 48h") +
  theme(plot.title = element_text(hjust = 0.5))
...
iregulon_plot_ATAC <- ggwithinstats(
  ...
  ggtitle ("AUC NicheNet vs ATAC 48h") +
  theme(plot.title = element_text(hjust = 0.5))
...
sp_plot_ATAC <- ggwithinstats(
  ...
  ggtitle ("Spearman NicheNet vs ATAC 48h") +
  theme(plot.title = element_text(hjust = 0.5))
...
pe_plot_ATAC <- ggwithinstats(
  ...
  ggtitle ("Pearson NicheNet vs ATAC 48h") +
  theme(plot.title = element_text(hjust = 0.5))


# Combine plots in one visualisation
combined_plot <- plot_grid(au_plot_ATAC, aupr_plot_ATAC, pe_plot_ATAC, sp_plot_ATAC)
ggsave("perf_stats_ATAC_48.png", combined_plot, width = 13, height = 11)
```
...
plt_OSM_aupr <- ggwithinstats(
  ...
  coord_cartesian(ylim = c(0, 0.3)) +
  theme(axis.title.x = element_blank(), plot.title = element_text(hjust = 0.5)) +
  ggtitle ("AUPR OSM 48h")

# Combine and save the plots
AUPR_48_ATAC_RNA <- plot_grid(plt_EGF_aupr, plt_HGF_aupr, plt_OSM_aupr, nrow = 1)
ggsave("ligand_AUPR_48_ATAC_RNA.png", AUPR_48_ATAC_RNA, height = 5, width = 10)
...
plt_OSM_auroc <- ggwithinstats(
  ...
  coord_cartesian(ylim = c(0.65, 0.8)) +
  theme(axis.title.x = element_blank(), plot.title = element_text(hjust = 0.5)) +
  ggtitle ("AUROC OSM 48h")

#Combine and save the plots
auroc_48_ATAC_RNA <- plot_grid(plt_EGF_auroc, plt_HGF_auroc, plt_OSM_auroc, nrow = 1)
ggsave("ligand_auroc_48_ATAC_RNA.png", auroc_48_ATAC_RNA, height = 5, widt = 10)
...
plt_OSM_pearson <- ggwithinstats(
  ...
  coord_cartesian(ylim = c(0, 0.3)) +
  theme(axis.title.x = element_blank(), plot.title = element_text(hjust = 0.5)) +
  ggtitle ("Pearson OSM 48h")

# Combine and save the plots
pearson_48_ATAC_RNA <- plot_grid(plt_EGF_pearson, plt_HGF_pearson, plt_OSM_pearson, nrow = 1)
ggsave("ligand_pearson_48_ATAC_RNA.png", pearson_48_ATAC_RNA, height = 5, width = 10)
...
plt_OSM_spearman <- ggwithinstats(
  ...
  coord_cartesian(ylim = c(0, 0.3)) +
  theme(axis.title.x = element_blank(), plot.title = element_text(hjust = 0.5)) +
  ggtitle ("Spearman OSM 48h")

# Combine and save the plots
spearman_48_ATAC_RNA <- plot_grid(plt_EGF_spearman, plt_HGF_spearman, plt_OSM_spearman, nrow = 1)
ggsave("ligand_spearman_48_ATAC_RNA.png", spearman_48_ATAC_RNA, height = 5, width = 10)
```
...
# Combine and save the plots
AUPR_48_ATAC <- plot_grid(plt_EGF_aupr, plt_HGF_aupr, plt_OSM_aupr, nrow = 1)
ggsave("ligand_AUPR_48_ATAC.png", AUPR_48_ATAC, height = 5, width = 10)
...
#Combine and save the plots
auroc_48_ATAC <- plot_grid(plt_EGF_auroc, plt_HGF_auroc, plt_OSM_auroc, nrow = 1)
ggsave("ligand_auroc_48_ATAC.png", auroc_48_ATAC, height = 5, width = 10)
...
# Combine and save the plots
pearson_48_ATAC <- plot_grid(plt_EGF_pearson, plt_HGF_pearson, plt_OSM_pearson, nrow = 1)
ggsave("ligand_pearson_48_ATAC.png", pearson_48_ATAC, height = 5, width = 10)
...
spearman_48_ATAC <- plot_grid(plt_EGF_spearman, plt_HGF_spearman, plt_OSM_spearman, nrow = 1)
ggsave("ligand_spearman_48_ATAC.png", spearman_48_ATAC, height = 5, width = 10)
```
...
gr_network_LINCS_OSM <- read.delim("C:/Users/klara/MaStat/Thesis/GithubThesis/Thesis_NicheNet/Ananse_networks/GRN/LINCS_MCF10A_OSM_48_grn.txt", header = TRUE, sep = ";")
gr_network_LINCS_HGF <- read.delim("C:/Users/klara/MaStat/Thesis/GithubThesis/Thesis_NicheNet/Ananse_networks/GRN/LINCS_MCF10A_HGF_48_grn.txt", header = TRUE, sep = ";")
gr_network_LINCS_EGF <- read.delim("C:/Users/klara/MaStat/Thesis/GithubThesis/Thesis_NicheNet/Ananse_networks/GRN/LINCS_MCF10A_EGF_48_grn.txt", header = TRUE, sep = ";")
...
new_network_weights_df_EGF <- tibble(source = "LINCS_MCF10A_EGF_48", avg_weight = 1, median_weight = 1)
new_source_weights_df_EGF <- optimized_source_weights_df %>% bind_rows(new_network_weights_df_EGF)

new_network_weights_df_HGF <- tibble(source = "LINCS_MCF10A_HGF_48", avg_weight = 1, median_weight = 1)
new_source_weights_df_HGF <- optimized_source_weights_df %>% bind_rows(new_network_weights_df_HGF)

new_network_weights_df_OSM <- tibble(source = "LINCS_MCF10A_OSM_48", avg_weight = 1, median_weight = 1)
...
#import one ligand GRN networks
gr_network_LINCS_OSM_ATAC <- read.delim("C:/Users/klara/MaStat/Thesis/GithubThesis/Thesis_NicheNet/Ananse_networks/GRN/LINCS_MCF10A_OSM_48_NO_RNAseq_grn.txt", header = TRUE, sep = ";")
gr_network_LINCS_HGF_ATAC <- read.delim("C:/Users/klara/MaStat/Thesis/GithubThesis/Thesis_NicheNet/Ananse_networks/GRN/LINCS_MCF10A_HGF_48_NO_RNAseq_grn.txt", header = TRUE, sep = ";")
gr_network_LINCS_EGF_ATAC <- read.delim("C:/Users/klara/MaStat/Thesis/GithubThesis/Thesis_NicheNet/Ananse_networks/GRN/LINCS_MCF10A_EGF_48_NO_RNAseq_grn.txt", header = TRUE, sep = ";")
...
#add your new source to the weighted networks in NicheNet (weight??)
new_network_weights_df_EGF_ATAC <- tibble(source = "LINCS_MCF10A_EGF_48_NO_RNAseq", avg_weight = 1, median_weight = 1)
new_source_weights_df_EGF_ATAC <- optimized_source_weights_df %>% bind_rows(new_network_weights_df_EGF_ATAC)

new_network_weights_df_HGF_ATAC <- tibble(source = "LINCS_MCF10A_HGF_48_NO_RNAseq", avg_weight = 1, median_weight = 1)
new_source_weights_df_HGF_ATAC <- optimized_source_weights_df %>% bind_rows(new_network_weights_df_HGF_ATAC)

new_network_weights_df_OSM_ATAC <- tibble(source = "LINCS_MCF10A_OSM_48_NO_RNAseq", avg_weight = 1, median_weight = 1)
...
au_plot_1 <- ggwithinstats( 
 ...
 y    = scorevalue, 
   ...
   ggtitle ("AUROC 100% DE genes, 48h") +
  coord_cartesian(ylim = c(0.65, 0.8)) +
...
print(au_plot)
ggsave("Mock_au_48_ATAC_RNA.png", au_plot, height = 10, width = 15)
...
print(aupr_plot)
ggsave("Mock_aupr_48_ATAC_RNA.png", aupr_plot, height = 10, width = 15)
...
sp_plot_0 <- ggwithinstats( 
 ...
 y    = scorevalue, 
   ...
   ggtitle ("Spearman 0% DE genes, 48h") +
  coord_cartesian(ylim = c(0, 0.3)) +
...
sp_plot_0.25 <- ggwithinstats( 
 ...
 y    = scorevalue, 
   ...
   ggtitle ("Spearman 25% DE genes, 48h") +
  coord_cartesian(ylim = c(0, 0.3)) +
...
sp_plot_0.5 <- ggwithinstats( 
 ...
 y    = scorevalue, 
   ...
   ggtitle ("Spearman 50% DE genes, 48h") +
  coord_cartesian(ylim = c(0, 0.3)) +
...
sp_plot_0.75 <- ggwithinstats( 
 ...
 y    = scorevalue, 
   ...
   ggtitle ("Spearman 75% DE genes, 48h") +
  coord_cartesian(ylim = c(0, 0.3)) +
...
sp_plot_1 <- ggwithinstats( 
 ...
 y    = scorevalue, 
   ...
   ggtitle ("Spearman 100% DE genes, 48h") +
  coord_cartesian(ylim = c(0, 0.3)) +
...
print(sp_plot)
ggsave("Mock_sp_48_ATAC_RNA.png", sp_plot, height = 10, width = 15)
...
pe_plot_0 <- ggwithinstats( 
 ...
 y    = scorevalue, 
   ...
   ggtitle ("Pearson 0% DE genes, 48h") +
  coord_cartesian(ylim = c(0, 0.3)) +
...
pe_plot_0.25 <- ggwithinstats( 
 ...
 y    = scorevalue, 
   ...
   ggtitle ("Pearson 25% DE genes, 48h") +
  coord_cartesian(ylim = c(0, 0.3)) +
...
pe_plot_0.5 <- ggwithinstats( 
 ...
 y    = scorevalue, 
   ...
   ggtitle ("Pearson 50% DE genes, 48h") +
  coord_cartesian(ylim = c(0, 0.3)) +
...
pe_plot_0.75 <- ggwithinstats( 
 ...
 y    = scorevalue, 
   ...
   ggtitle ("Pearson 75% DE genes, 48h") +
  coord_cartesian(ylim = c(0, 0.3)) +
...
pe_plot_1 <- ggwithinstats( 
 ...
 y    = scorevalue, 
   ...
   ggtitle ("Pearson 100% DE genes, 48h") +
  coord_cartesian(ylim = c(0, 0.3)) +
...
print(pe_plot)
ggsave("Mock_pe_48_ATAC_RNA.png", pe_plot, height = 10, width = 15)
``` 