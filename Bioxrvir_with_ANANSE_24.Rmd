...
gr_network_LINCS_OSM <- read.delim("Ananse_networks/LINCS_MCF10A_OSM_24_NO_RNAseq.network.txt", header = TRUE, sep = ";")
gr_network_LINCS_HGF <- read.delim("Ananse_networks/LINCS_MCF10A_HGF_24_NO_RNAseq.network.txt", header = TRUE, sep = ";")
gr_network_LINCS_EGF <- read.delim("Ananse_networks/LINCS_MCF10A_EGF_24_NO_RNAseq.network.txt", header = TRUE, sep = ";")
...
new_network_weights_df <- tibble(source = "LINCS_MCF10A_TGFB_24", weight = 1)
...
#   writexl::write_xlsx(performances_all, path = "NicheNet_output/performances_all_ANANSE_24.xlsx")
#     
...
if(length(expression_settings_validation_DE_one) > 0){
  ...
  writexl::write_xlsx(performances_one, path = "NicheNet_output/performances_one_ANANSE_24.xlsx")
...
#    writexl::write_xlsx(evaluation_ligand_prediction_all, path = "NicheNet_output/ligand_all_ANANSE_24.xlsx")
#     
...
if(length(settings_one) > 0){
  ...
  settings_ligand_prediction_one = settings_one %>% convert_settings_ligand_prediction(all_ligands = all_ligands, validation = TRUE)
   ...
   print(evaluation_ligand_prediction_one, caption = "Evaluation ligand prediction one")
