...
# Create a list of plots for different metrics
plots <- lapply(metrics, function(metric) {
...
plots <- lapply(metrics, function(metric) {
  p <- ggplot(ligand_importances, aes(x = setting, y = .data[[metric]])) +
    ...
    scale_color_discrete() +
    theme_minimal() +
    theme(legend.position = "none", plot.title = element_text(size = 14, hjust = 0.5)) +  # Adjust title size and centering
    theme(plot.margin = margin(1, 1, 1, 1, "cm")) +
    theme(legend.title = element_blank(), legend.text = element_text(size = 12))
...
# Add the legend in the middle of the combined plots
combined_plots_with_legend <- combined_plots +
  theme(legend.position = "center")

combined_plots_with_legend +
  plot_layout(widths = c(20), heights = c(20))
combined_plots_with_legend

# Save the combined plots with the overall title in the middle and a single legend
ggsave("NicheNet.png", plot = combined_plots_with_legend, width = 20, height = 20, dpi = 300)
...
# Save the combined plots with the overall title in the middle and a single legend
ggsave("NicheNet with ATAC NO RNA seq 24.png", plot = combined_plots_with_legend, width = 20, height = 20, dpi = 300)
...
# Save the combined plots with the overall title in the middle and a single legend
ggsave("NicheNet with ATAC RNA seq 24.png", plot = combined_plots_with_legend, width = 20, height = 20, dpi = 300)
...
# Save the combined plots with the overall title in the middle and a single legend
ggsave("NicheNet with ATAC NO RNA seq 48.png", plot = combined_plots_with_legend, width = 20, height = 20, dpi = 300)
...
# Save the combined plots with the overall title in the middle and a single legend
ggsave("NicheNet with ATAC RNA seq 48.png", plot = combined_plots_with_legend, width = 20, height = 20, dpi = 300)
